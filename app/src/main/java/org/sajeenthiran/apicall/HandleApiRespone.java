...
public class HandleApiRespone {
    private IpService mClient = null;

    public HandleApiRespone(Context context,String url) {
        init(context,url);
    }
    ...
    public void login(String userName,String password,CallBackDelegate delegate){

        mClient.loginService("22612","12345","123","123","123").enqueue(new Callback<JsonArray>() {
